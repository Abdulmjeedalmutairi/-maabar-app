...
const SECTIONS = {
  ar: [
    ...
    { title: '١٣. الاختصاص القضائي', body: 'تخضع هذه الشروط لأنظمة المملكة العربية السعودية. في حال نشوء نزاع لم يُسوَّ وفق آلية مَعبر، يختص القضاء السعودي بالنظر فيه.' },
